...
| :---: | :--- | :---: | :---: | :--- |
| 1 | Repository Audit | **PASS** | 0.05s | Repository audit passed on branch 'main' @ 8b1afed. |
| 2 | Dependency Verification | **PASS** | 3.60s | Dependencies & Repository Integrity Audit verified. |
| 3 | Formatting Check | **PASS** | 0.00s | Formatting check passed. 0 formatting issues detected. |
| 4 | Linting Check | **PASS** | 0.04s | Linting check passed. 34 Python source file(s) AST-compiled cleanly. |
| 5 | Type Check & Static Analysis | **PASS** | 0.18s | Static analysis & type import check passed. |
| 6 | Production Build | **PASS** | 3.25s | Production package build succeeded (8 artifacts). |
| 7 | Test Suite | **FAIL** | 11.68s | Test suite failed. |
...
- **Message**: Repository audit passed on branch 'main' @ 8b1afed.
- **Details**:
  - `Active Branch: main`
  - `HEAD Commit: 8b1afed`
...
- **Message**: Production package build succeeded (8 artifacts).
- **Details**:
...
- **Details**:
  - `FAILED tests/test_commands.py::TestLayer2NexTermCommands::test_version_command`
